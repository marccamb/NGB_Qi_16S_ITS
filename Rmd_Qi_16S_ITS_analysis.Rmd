...
* There is a significant effect of predawn water potential, but as we only have one value of wp per block, we need to disentangle the block and the irrigation effect. We should probably replace the block vrariable per a pcnm of the trees coordinates.
