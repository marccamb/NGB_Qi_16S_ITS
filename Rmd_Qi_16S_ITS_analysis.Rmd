...
Here, I try to predict tree irrigation treatment from their leaf microbial communities, using random forest. I will try several `mtry` parameters and toxonomical levels, following Chang et al. (2017) DOI:10.3389/fmicb.2017.00519
...
res_tot <- rf.mtry.taxo(tab, taxo, treat = z$irrigation, n_mtry = 5)

plot(res_mean~mtry, type='n', ylim=c(0,1), xlim=c(0,200),
     data=res_tot[["ASV"]])
lapply(res_tot, function(x){
